...
export const getMainPrompt = ({
  ...
  Preferenze alimentari includono: pasta circa 100 grammi a testa, riso 70 grammi a testa, ${dietaryPreferences}. Cerca di accontentare tutti, senza proporre piatti diversi per ognuno, tranne a Colazione.  Per le colazioni, ${
  sameBreakfast
