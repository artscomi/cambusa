...
export const getMainPrompt = ({
  ...
  Cerca di accontentare tutti, senza proporre piatti diversi per ognuno. Per le colazioni, ${
    sameBreakfast
  ...
  }. Non includere nel menu integratori alimentari. Proponi sempre sia carboidrati che proteine a pranzo e cena. Ma privilegia i carboidrati a pranzo e le proteine a cena.
