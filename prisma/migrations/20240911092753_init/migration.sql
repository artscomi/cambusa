/*
  ...
  - You are about to drop the column `preferences` on the `FoodPreference` table. All the data in the column will be lost.
  - Added the required column `preference` to the `FoodPreference` table without a default value. This is not possible if the table is not empty.
